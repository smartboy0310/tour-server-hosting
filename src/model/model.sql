...
CREATE TABLE shrines (
   ...
   shrine_adderss_oz text not null,
   shrine_adderss_uz text not null,
   shrine_adderss_ru text not null,
   shrine_adderss_en text not null,
   shrine_location_x text not null,
   shrine_location_y text not null,
   shrine_phone varchar(32) not null,
   shrine_type_oz text not null,
   shrine_type_uz text not null,
   shrine_type_ru text not null,
   shrine_type_en text not null,
   shrine_top int not null,
   shrine_video text not null,
   shrine_video_name text not null,
   shrine_audio_oz text not null,
   shrine_audio_ru text not null,
   shrine_audio_en text not null,
   shrine_audio_name_oz text not null,
   shrine_audio_name_ru text not null,
   shrine_audio_name_en text not null,
...
CREATE TABLE games (
   ...
   game_type_oz text not null,
   game_type_uz text not null,
   game_type_ru text not null,
   game_type_en text not null,
...
CREATE TABLE special_object (
   ...
   object_adderss_oz text not null,
   object_adderss_uz text not null,
   object_adderss_ru text not null,
   object_adderss_en text not null,
   object_location_x text not null,
   object_location_y text not null,
   ...
   object_type_oz text not null,
   object_type_uz text not null,
   object_type_ru text not null,
   object_type_en text not null,
   object_add_type text not null,
