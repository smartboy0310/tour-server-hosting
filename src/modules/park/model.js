...
class Parks extends PG {
   ...
   SEARCH_PARKS(search_data, page, limit) {
      ...
      FROM
            special_object
      WHERE 
               object_is_delete = false AND object_add_type = 'park' AND (object_name ->> 'oz' ILIKE $2 OR object_name ->> 'uz' ILIKE $2 OR object_name ->> 'ru' ILIKE $2 OR object_name ->> 'en' ILIKE $2 OR object_info ->> 'oz' ILIKE $2 OR object_info ->> 'uz' ILIKE $2 OR object_info ->> 'ru' ILIKE $2 OR object_info ->> 'en' ILIKE $2)
      ORDER BY
               object_id DESC
     OFFSET $2 LIMIT $3  
   ...
   COUNT_PARKS_SEARCH(search_data) {
      ...
      FROM
            special_object
      WHERE 
            object_is_delete = false AND object_add_type = 'park' AND (object_name ->> 'oz' ILIKE $1 OR object_name ->> 'uz' ILIKE $1 OR object_name ->> 'ru' ILIKE $1 OR object_name ->> 'en' ILIKE $1 OR object_info ->> 'oz' ILIKE $1 OR object_info ->> 'uz' ILIKE $1 OR object_info ->> 'ru' ILIKE $1 OR object_info ->> 'en' ILIKE $1)
   `, search_data)
   }
   ...
   ADD_PARK(object_name, object_title, object_info, object_address, object_location, object_phone, object_work_time, object_link, object_photo, object_photo_name, object_type, object_status, region_id, shrine_id) {
      return this.fetch(`
         INSERT INTO
                     special_object ( 
                           object_name, 
   ...
   UPDATE_PARK(object_id, object_name, object_title, object_info, object_address, object_location, object_phone, object_work_time, object_link, object_photo, object_photo_name, object_type, object_status, region_id, shrine_id) {
      return this.fetch(`
         UPDATE
                  special_object 
         SET
