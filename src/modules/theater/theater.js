...
module.exports = {
   GET: async (req, res) => {
      try {
         ...
         if (search_data) {
            ...
            const foundData = await model.SEARCH_THEATERS(`%${search_data}%`, page, limit)
            ...
            const foundData = await model.ALL_THEATERS(page, limit)
   ...
   PUT: async (req, res) => {
      try {
         ...
         const updateTheater = await model.UPDATE_THEATER(id, name_oz, name_uz, name_ru, name_en, title_oz, title_uz, title_ru, title_en, info_oz, info_uz, info_ru, info_en, address_oz, address_uz, address_ru, address_en, location_x, location_y, phone, work_time, link, photo, photo_name, type_oz, type_uz, type_ru, type_en, status, region_id, shrine_id)
