...
module.exports = {
   GET: async (req, res) => {
      try {
         ...
         if (search_data) {
            ...
            const foundData = await model.SEARCH_TRAINS(`%${search_data}%`, page, limit)
            ...
            const foundData = await model.ALL_TRAINS(page, limit)
   ...
   POST: async (req, res) => {
      try {
         ...
         const createTrain = await model.ADD_TRAIN(name_oz, name_uz, name_ru, name_en, title_oz, title_uz, title_ru, title_en, info_oz, info_uz, info_ru, info_en, address_oz, address_uz, address_ru, address_en, location_x, location_y, phone, link, photo, photo_name, type_oz, type_uz, type_ru, type_en, status, region_id, shrine_id)
   ...
   PUT: async (req, res) => {
      try {
         ...
         const updateTrain = await model.UPDATE_TRAIN(id, name_oz, name_uz, name_ru, name_en, title_oz, title_uz, title_ru, title_en, info_oz, info_uz, info_ru, info_en, address_oz, address_uz, address_ru, address_en, location_x, location_y, phone, link, photo, photo_name, type_oz, type_uz, type_ru, type_en, status, region_id, shrine_id)
